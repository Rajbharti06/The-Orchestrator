const PROVIDERS = {
  groq: { speed: 9.5, cost: 9.5, reliability: 7 },
  openrouter: { speed: 8, cost: 8, reliability: 8.5 },
  ollama: { speed: 5, cost: 10, reliability: 9 },
  openai: { speed: 7, cost: 5, reliability: 9.5 },
  claude: { speed: 7, cost: 4, reliability: 9.5 }
};
